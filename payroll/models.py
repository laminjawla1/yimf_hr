...
class Payroll(models.Model):
    ...
    provincial_allowance = models.FloatField(default=0.0)
    ...
    total_deduction = models.FloatField(default=0.0, validators=[MinValueValidator(0)])
    ...
    ninety_percent_net = models.FloatField(default=0.0)
    ten_percent_net = models.FloatField(default=0.0)
