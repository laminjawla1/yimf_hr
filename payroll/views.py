...
class AddPayrollView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        form.instance.basic_salary = round(form.instance.basic_salary, 2)
        form.instance.medical_allowance = round(form.instance.basic_salary * 0.1666666667, 2)
        form.instance.transport_allowance = round(form.instance.basic_salary * 0.2333333333, 2)
        form.instance.responsibility_allowance = round(form.instance.basic_salary * 0.4666666667, 2)
        form.instance.housing_allowance =round( form.instance.basic_salary * 0.1333333333, 2)
        ...
        form.instance.income_tax = round(((((form.instance.gross_pay * 12) - 64000) * (25 / 100)) + 5000) / 12, 2)
        form.instance.sshfc = round((10 / 100) * form.instance.basic_salary, 2)
        form.instance.individual_sshfc = round((5 / 100) * form.instance.basic_salary, 2)
        form.instance.individual_sshfc = round((5 / 100) * form.instance.basic_salary, 2)
        form.instance.net_pay = round(form.instance.gross_pay - form.instance.income_tax - form.instance.individual_sshfc - form.instance.icf - form.instance.deduction - form.instance.staff_fin, 2)
